...
```bash
`ros2 run teleop_twist_keyboard teleop_twist_keyboard --ros-args -p stamped:=true --remap /cmd_vel:=/NS_1/swerve_drive_controller/cmd_vel`
```
Replace NS_1 with the your custom robot namespace.
